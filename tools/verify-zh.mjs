...
const original = fs.readFileSync("public/documents/personal-data-consent.html", "utf8")
assert.match(original, /<html lang="ru-RU"/)
assert.match(original, /本页暂为俄文原文/)
assert.match(original, /href="https:\/\/catoblepaspress.ru\/documents\/personal-data-consent"/)
